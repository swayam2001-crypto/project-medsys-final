      ...
      <div className='flex bg-[#f6d5dd] h-full w-full'>
        ...
        <div className='bg-[#f6d5dd] h-full w-9/12 px-12 py-12 '>
          ...
          <div className='my-12' id='Advantages'>
            ...
            <div>
              <div className='my-2'>
                <h2 className='text-lg font-bold text-red-700'>Safety from misuse</h2>
              ...
              <div className='my-2'>
                <h2 className='text-lg font-bold text-red-700'>Expandable validity</h2>
                <p>A Design registration is valid for a period of 10 years. This validity period can be extended up to 5 more years</p>
              </div>
              <div className='my-2'>
                <h2 className='text-lg font-bold text-red-700'>Unique Selling Point</h2>
              ...
              <div className='my-2'>
                <h2 className='text-lg font-bold text-red-700'>Protects Originality</h2>
              ...
              <div className='my-2'>
                <h2 className='text-lg font-bold text-red-700'>Induces Client Response</h2>
                <p>An important criterion for registering a design is that it should appeal to and is judged solely by the eye.</p>
              </div>
              <div className='my-2'>
                <h2 className='text-lg font-bold text-red-700'>Promotes Creativity</h2>
          ...
          <div className='my-12' id='Process'>
            ...
            <ul className='list-disc'>
              <li className='my-4'><span className='text-red-700 mr-2'>Step:1</span>Upload required documents & information of the article on our web portal.</li>
              <li className='my-4'><span className='text-red-700 mr-2'>Step:2</span>Consult our business advisor regarding design registration form.</li>
              <li className='my-4'><span className='text-red-700 mr-2'>Step:3</span>Our professional will verify the validity of documents & Information provided.</li>
              <li className='my-4'><span className='text-red-700 mr-2'>Step:4</span>On Confirmation, make online payment with different payments modes available.</li>
              <li className='my-4'><span className='text-red-700 mr-2'>Step:5</span>The design registration form will be filled as per the details of your product.</li>
              <li className='my-4'><span className='text-red-700 mr-2'>Step:6</span>On verification, the Controller of Design shall issue Design certificate</li>
            </ul>
          ...
          <div className='my-12' id='Documents'>
            ...
            <div>
              <div className='flex items-center my-4'>
                ...
                <div className='mx-2'>
                  <h2 className="text-xl text-red-700 font-bold">Design</h2>
              ...
              <div className='flex items-center my-4'>
                <img src={TOW} alt="" />
                <div className='mx-2'>
                  <h2 className="text-xl text-red-700 font-bold">Title of Work</h2>
                </div>
              </div>
              <div className='flex items-center my-4'>
                <img src={DOW} alt="" />
                <div className='mx-2'>
                  <h2 className="text-xl text-red-700 font-bold">Description of Work</h2>
                </div>
              </div>
            </div>
